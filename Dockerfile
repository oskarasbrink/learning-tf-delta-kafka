...
ENV SPARK_HOME=/root/spark-3.3.1-bin-hadoop3-scala2.13
...
# https://downloads.apache.org/spark/spark-3.3.1/spark-3.3.1-bin-hadoop3-scala2.13.tgz
# https://www.apache.org/dyn/closer.lua/spark/spark-3.3.1/spark-3.3.1-bin-hadoop3-scala2.13.tgz
# https://downloads.apache.org/spark/spark-3.3.1/spark-3.3.1-bin-hadoop3.tgz
...
ENV HADOOP_HOME=/root/hadoop-3.3.2-src
ENV HADOOP_CONF_DIR=/root/hadoop-3.3.2-src/etc/hadoop
ENV PATH=$PATH:$HADOOP_HOME/bin:$HADOOP_HOME/sbin

RUN wget https://dlcdn.apache.org/hadoop/common/hadoop-3.3.2/hadoop-3.3.2-src.tar.gz && \
    tar -xzf hadoop-3.3.2-src.tar.gz && \
    rm hadoop-3.3.2-src.tar.gz




# Downloading delta-core jar
RUN cd $SPARK_HOME/jars && wget https://repo1.maven.org/maven2/io/delta/delta-core_2.13/2.2.0/delta-core_2.13-2.2.0.jar
...
RUN cd $SPARK_HOME/jars && wget https://repo1.maven.org/maven2/org/scalatest/scalatest_2.13/3.2.9/scalatest_2.13-3.2.9.jar
