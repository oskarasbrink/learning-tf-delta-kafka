...
ls -al /home/ec2-user
pwd
sudo docker run --rm -i --name=spark3x-delta --mount type=bind,source=/home/ec2-user/GIT,destination=/root/GIT -p 4040:4040 spark3x-delta /bin/bash /root/GIT/exjobb/learning-tf-delta-kafka/learn-terraform-docker-container/docker-start.sh
